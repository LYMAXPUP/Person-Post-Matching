...
def get_ner_predict(text,max_seq_length,learning_rate,train_batch_size,num_train_epochs,output_dir,
          bert_config_file,vocab_file,init_checkpoint):
...
text = "1、从事研发工作1-3年以上2、使用过一种或以上数据库如oracle、PostgreSQL等，有使用PL/SQL等SQL开发工具经验3、有springboot、MyBatis、SpringMVC等一种或几种项目开发经验4、具有ETL，ES，HIVE等大数据开发经验者优先5、有金融保险相关项目经验，熟悉寿险营销员作业流程及管理流程者优先"
get_ner_predict(text,max_seq_length=512,learning_rate=2e-5,train_batch_size=8,num_train_epochs=2.0,
          output_dir='output',
