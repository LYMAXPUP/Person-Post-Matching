...
tokenizer_ = FullTokenizer(vocab_file=vocab_file)
...
if __name__ == "__main__":
    text_ = "1）计算机科学与技术、软件开发、信息管理等相关专业；2）参与公司软件系统的建设和维护，负责公司业务信息系统、ERP、OA、邮箱的运维和技术支持；3）熟悉ERP、供应链系统、财务系统的规划及实施工作；4）能熟练编写软件需求、培训、使用手册等相关文档；5）有金蝶ERP系统维护经验优先考虑。6）至少一年以上系统维护经验；7）本科以上学历"
    res_ = predict(text_)
    print(res_)
